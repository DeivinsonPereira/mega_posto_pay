...
public class GertecPrinter {
    ...
    public void imprimeTexto(String texto) throws Exception {
        ...
        try {
            ...
            Log.d("Imprimir", "Imprimindo texto método imprimeTexto linha 209");
            sPrintLine(texto);
        } catch (Exception e) {
     ...
     *
     */
    private boolean sPrintLine(String texto) {
        try {
            Log.d("Imprimir", "Inicializando impressora...");
            ImpressoraInit();
            Log.d("Imprimir", "Impressora inicializada, imprimindo texto...");
            this.iPrint.DrawStringExt(this.stringConfig, texto);
            Log.d("Imprimir", "Texto impresso, avançando linhas...");
            this.avancaLinha(configPrint.getAvancaLinhas());
            ImpressoraOutput();
            Log.d("Imprimir", "Finalizando impressão...");
            return true;
        } catch (GediException e) {
            Log.e("Imprimir", "Erro ao imprimir: " + e.getMessage());
            return false;
        } catch (Exception e) {
            Log.e("Imprimir", "Erro não esperado: " + e.getMessage());
            return false;
        }
    }
